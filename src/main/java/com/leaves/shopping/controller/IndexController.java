...
public class IndexController {
	...
	public String index(@RequestParam(value = "type", defaultValue = "") String type, ModelMap map, HttpSession session)
			throws Exception {
		String isBuy = "1";
		String isNotBuy = "2";
		String isSell = "1";
	...
	public String detail(@RequestParam("id") Integer id, @RequestParam(value = "type", defaultValue = "") String type,
