...
public class AccountController {
	...
	public String account(ModelMap map, HttpSession session) throws Exception {
	...
	public String snapshot(@RequestParam("id") Integer id, ModelMap map) throws Exception {
		try {
